...
index d0d9e2a..e0a55aa 100644
--- a/docs/storyboard-acceptance-runbook.md
+++ b/docs/storyboard-acceptance-runbook.md
@@ -9,63 +9,63 @@ Use this runbook to verify the complete storyboard flow from a clean project fol
